...
# #     global counter
# #     for _ in range(10000): # Increment counter a million times
# #         # with lock: # Acquire the lock before accessing the counter
# #         #     counter += 1
# #         counter += 1
# # # Create and start multiple threads
# # threads = []
# # for _ in range(200):  # Two threads incrementing the counter
...
# # print(f"Counter: {counter}")  # Expected output: 2000000
